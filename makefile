...
CPPFLAGS = ${BASEFLAGS} -mtune=generic -march=i686 -mmmx -msse -msse2 -mfpmath=387 -m32 \
	-Wall -w -fPIC \
	-I. -I../engine -I../common -I../pm_shared -I../dlls -I../public

OBJ = bot.o bot_client.o bot_combat.o bot_config.o bot_manager.o \
	bot_navigate.o bot_start.o client_commands.o console_output.o \
	dll.o engine.o h_export.o linkfunc.o mb_hud.o namefunc.o util.o waypoint.o
